...
export class ApInboxService {
	...
	@bindThis
	public async performActivity(actor: MiRemoteUser, activity: IObject, additionalCc?: MiLocalUser['id']): Promise<string | void> {
	...
	@bindThis
	public async performOneActivity(actor: MiRemoteUser, activity: IObject, additionalCc?: MiLocalUser['id']): Promise<string | void> {
	...
	@bindThis
	private async create(actor: MiRemoteUser, activity: ICreate, additionalCc?: MiLocalUser['id']): Promise<string | void> {
		const uri = getApId(activity);
